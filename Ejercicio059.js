...
Si myVal es igual a 10, el operador de igualdad devuelve true, así que el código dentro de los corchetes se ejecutará y la función devolverá Equal.
...
tiene que convertir un tipo a otro. Esto se conoce como coerción de Tipo. Sin embargo, una vez lo hace, puede comparar términos como se ve a continuación:
...
Aprobado: testEqual(12) debe devolver la cadena Equal
Aprobado: testEqual("12") debe devolver la cadena Equal
